...
export function FileDropBox({
  ...
  const handleSubmit = async () => {
    if (!tableName.trim() || files.length === 0) return;
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter a name for your table and drop your file to create a new
            table.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button
                ...
                disabled={
                  !tableName.trim() || files.length === 0 || isUploading
                }
              >
                {isUploading ? "Creating..." : "Create Table"}
              </Button>
            </div>
          </div>
        </div>
